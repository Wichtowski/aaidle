...
- Name: specs/e2e/authenticated/account-routes.spec.ts >> authenticated user can access the account-disabled page
...
> 14 |   await expect(profilePage.heading).toBeVisible();
  ...
  31 | });
  32 | 
  33 | test("account deletion confirmation requires the emailed single-use link", async ({
  34 |   deleteAccountPage,
  35 |   profilePage,
  36 | }) => {
  37 |   await deleteAccountPage.goto();
  38 | 

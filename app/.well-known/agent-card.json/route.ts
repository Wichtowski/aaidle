const agentCard = {
  ...
  description:
    "Retrieve and solve the current aAIdle Classic game through structured game and guess responses.",
  version: "1.0.0",
  supportedInterfaces: [
    {
  ...
  skills: [
    {
      ...
      description:
        "Returns the current challenge, candidate model index, expiry time, and comparison columns for a Classic category and difficulty.",
    ...
    },
    {
      ...
      description:
        "Evaluates a candidate model against the current challenge and returns comparison clues plus correctness.",

    ...
    <main className="page">
      ...
      <article className="prose privacy-page">
        ...
        <p>
          ...
          maintain a secure session. During sign-in with a provider, a short-lived security cookie
          helps protect the sign-in process.
        </p>
        ...
        <h2>Your choices</h2>
        <p>
          You can choose essential cookies only or accept all cookies from the consent dialog. At
          the moment, both choices keep only the cookies needed for aAIdle to work because we do not
        ...
        <p>
          If the way we use cookies or device data changes, we will update this page and ask for a
          new choice when required. If you have a question about this notice, please contact the
          aAIdle team through the project&apos;s public channels.
        </p>
      </article>
    </main>
  );

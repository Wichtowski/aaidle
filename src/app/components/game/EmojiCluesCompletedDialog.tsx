...
import type { EmojiCluesDifficulty } from "@lib/api/client";
...
export function EmojiCluesCompletedDialog({
  difficulty,
  guessCount,
  clueCount,
  ...
  return (
    ...
    >
      ...
      <section className="completed completed--emoji" ref={modalRef}>
        ...
        <div className="completed__stats" aria-label="Your Emoji Clues result">
          <div>

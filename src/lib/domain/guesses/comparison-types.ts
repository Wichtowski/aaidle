...
export const classicColumnHeadings: Record<ClassicColumn, string> = {
  ...
  weightAvailability: "Weights",
  supportedLanguages: "Languages",
  toolUse: "Tool calling",
  multimodal: "Multimodal",
  visionTasks: "Vision tasks",
  architecture: "Architecture",
  trainingDatasets: "Training data",
  license: "License",
  nlpTasks: "NLP tasks",
  detectionTypes: "Detection",
  realTimeCapable: "Real-time",
  algorithmTypes: "Algorithm",
  learningParadigms: "Learning",
  objectives: "Objective",
  featureTypes: "Features",
  frameworks: "Framework",
  operationTypes: "Operation",
  kernelBased: "Kernel",
  kernelSizes: "Kernel sizes",
  linearity: "Linearity",

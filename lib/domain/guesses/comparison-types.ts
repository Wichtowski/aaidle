...
export const classicColumns = [
  ...
  "objectives", "featureTypes", "frameworks",
] as const;
...
export const classicColumnsByCategory = {
  ...
  hardcore: ["provider", "family", "categories", "inputModalities", "outputModalities", "useCases", "release", "weightAvailability"],

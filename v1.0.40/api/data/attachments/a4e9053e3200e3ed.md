...
- Name: specs/api/public-api.spec.ts >> Hardcore account can load the Hardcore game
- Location: tests/specs/api/public-api.spec.ts:73:1
...
> 18  |   expect(login.ok).toBe(true);
  ...
  93  |     method: "POST",
  94  |     headers: apiHeaders({ "Content-Type": "application/json" }),
